...
<head>
    ...
    <title>Авторизация | Турагентство "Земеля"</title>
</head>
...
<main>
    <section class="flex items-center justify-center bg-gray-100 py-10">
      <div class="bg-white shadow-md rounded-2xl p-8 w-full max-w-md">
        ...
        <form class="space-y-5"  method="POST" action="/auth/login.php">
          <div>
            <label class="block text-gray-700 mb-1 font-medium">Email</label>
            <input type="email" name="email"
              class="w-full border border-gray-300 rounded-xl py-2 px-3 focus:ring-2 focus:ring-blue-500 focus:outline-none"
          ...
          <button type="submit"
            class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 rounded-xl shadow transition">Войти</button>


          <p class="text-center text-sm text-gray-600">Забыли пароль? <a href="tel:89999999999"
              class="text-blue-600 hover:underline">Позвонить администратору</a></p>

              <?php
                if (!empty($_SESSION['error'])) {
                      echo "<p class='text-red-600 text-center mt-2'>" . $_SESSION['error'] . "</p>";
