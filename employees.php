...
require_once __DIR__ . '/queries/manager_list.php';
...
<head>
  ...
  <title>Сотрудники | Турагентство "Земеля"</title>
</head>
  ...
  <main>
    ...
    <?php if ($error): ?>
      <div class="mx-4 my-4 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-lg">
        Ошибка изменения сотрудника. Обратитесь к администратору
      </div>
    <?php endif; ?>
    <section class="min-h-screen bg-gray-100 py-10 px-4">

      <div class="bg-white rounded-2xl shadow-md p-6 mb-10 overflow-x-auto">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Список сотрудников</h1>
        ...
        <table class="w-full border border-gray-200 rounded-xl overflow-hidden">
          ...
          <tbody class="text-gray-700">
            ...
            <?php foreach ($managers as $row): ?>
              <tr class="border-b">
                <td class="p-3"><?= $row['manager_id'] ?></td>
                ...
                <td class="p-3 flex gap-2">
                  <a href="/edits/manager-edit.php?id=<?= $row['manager_id'] ?>"
                    class="px-3 py-1 text-sm bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg">
                    Изменить
                  </a>

                  <a href="/edits/manager-delete.php?id=<?= $row['manager_id'] ?>"
      ...
      <div class="bg-white rounded-2xl shadow-md p-8 w-full max-w-3xl mx-auto">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Добавить нового сотрудника</h2>

        <form id="adding-form" data-form="create_manager.php" class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <!-- Пароль -->
          <div>
            <label class="block mb-1 text-gray-700 font-medium">Пароль *</label>
