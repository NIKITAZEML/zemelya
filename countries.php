...
require_once __DIR__ . '/queries/countries_list.php';
...
<head>
  ...
  <title>Страны | Турагентство "Земеля"</title>
</head>
...
<body class="bg-gray-100">
  ...
  <main>
    ...
    <section class="min-h-screen bg-gray-100 py-10 px-4">
        ...
        <table class="w-full border border-gray-200 rounded-xl overflow-hidden">
          ...
          <tbody class="text-gray-700">
            ...
            <?php foreach ($countries as $row): ?>
              <tr class="border-b">
                <td class="p-3"><?= $row['country_id'] ?></td>
                <td class="p-3"><?= $row['country_name'] ?></td>
                <td class="p-3"><?= $row['visa_status'] ?></td>

                <td class="p-3 flex gap-2">
                  <a href="/edits/country-edit.php?id=<?= $row['country_id'] ?>"
                    class="px-3 py-1 text-sm bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg">
                    Изменить
                  </a>

                  <a href="/edits/country-delete.php?id=<?= $row['country_id'] ?>"
      ...
      <div class="bg-white rounded-2xl shadow-md p-8 w-full max-w-xl mx-auto">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Добавить страну</h2>

        <form  id="adding-form" data-form="create_country.php" class="grid grid-cols-1 gap-6">

          <!-- Название страны -->
          <div>
            <label class="block mb-1 text-gray-700 font-medium">Название страны *</label>
            <input type="text" name="country_name" required class="w-full border border-gray-300 rounded-xl py-2 px-3
          ...
          <div>
            ...
            <select name="is_visa_required" required class="w-full border border-gray-300 rounded-xl py-2 px-3
                           focus:ring-2 focus:ring-blue-500 outline-none">
